...
export class SvgMask extends Component {
    ...
    render() {
        ...
        const { dismissOnPress, stop, next, isLastStep } = this.props;
        console.log('dat props ', this.props)
        const Wrapper = dismissOnPress ? TouchableWithoutFeedback : View;
        return (React.createElement(Wrapper, { style: this.props.style, onLayout: this.handleLayout, pointerEvents: 'none', onPress: dismissOnPress ? isLastStep ? stop : next : undefined },
