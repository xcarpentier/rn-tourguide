import { IStep, Steps, SVGMaskPathMorphParam, SvgPath, ValueXY } from './types';
...
export declare const defaultSvgPath: ({ size, position, borderRadius: radius, }: {
    size: ValueXY;
    position: ValueXY;
    borderRadius: number;
}) => SvgPath;
...
export declare const svgMaskPathMorph: ({ previousPath, animation, to: { position, size, shape, maskOffset, borderRadius }, }: SVGMaskPathMorphParam) => string;
